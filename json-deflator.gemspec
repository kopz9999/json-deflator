...
Gem::Specification.new do |spec|
  spec.name          = "json-deflator"
  spec.version       = Json::Deflator::VERSION
  ...
  spec.summary       = %q{This ruby gem actually contains the necessary logic to 
    decycle a JSON object.}
  spec.description   = %q{This ruby gem actually contains the necessary logic to 
    decycle a JSON object. This will remove circular references.}
  spec.homepage      = "https://github.com/kopz9999/json-deflator"
